          ...
          <div className="space-y-8 animate-fade-in-up animate-delay-200">
              ...
              {contatos.map((contato, index) => {
                ...
                return (
                  <a
                    ...
                    target={contato.titulo === "WhatsApp" ? "_blank" : undefined}
                    rel={contato.titulo === "WhatsApp" ? "noopener noreferrer" : undefined}
                  >
            ...
            <div className="card-glass p-6 border border-accent/20">
              <div className="flex items-center mb-4">
                <Clock className="h-5 w-5 text-accent mr-3" aria-hidden="true" />
                <span className="font-bold text-primary">Horário de Atendimento</span>
              </div>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-accent font-semibold">Emergências:</span>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="crimes-pessoa">Crimes contra a Pessoa</option>
                    <option value="crimes-patrimoniais">Crimes Patrimoniais</option>
                ...
                <div className="bg-accent/10 border border-accent/20 p-6 rounded-2xl">
                  <p className="text-sm text-primary">
                    <span className="text-accent font-bold">🔒 Sigilo Garantido:</span> Todas as informações
                    compartilhadas são protegidas pelo sigilo profissional e
        ...
        <div className="text-center animate-fade-in-up animate-delay-400">
          <div className="card-glass border border-red-500/30 p-8 lg:p-12 max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-6">
              <AlertTriangle className="h-8 w-8 text-red-400 mr-4" aria-hidden="true" />
